 ...
 */
InteractiveSurface::InteractiveSurface(int width, int height, int x, int y, int bpp) : Surface(width, height, x, y, bpp), _buttonsPressed(0), _in(0), _over(0), _out(0), _isHovered(false), _isFocused(true), _listButton(false)
{
}
